...
<template>
  ...
  >
        ...
        <div class="flex items-center gap-2">
            ...
            <SheetContent side="left" class="w-80 p-0">
              <aside class="h-full flex flex-col">
                ...
                >
                  ...
                  >
                    <span class="text-primary font-bold">Y</span>
                  </div>
                  <span class="font-semibold">Yugioh Manager</span>
                </div>
          ...
          >
            <div
              class="size-7 rounded-md bg-primary/12 grid place-items-center"
            >
              <span class="text-primary font-bold tracking-tight">Y</span>
            </div>
        ...
        <div class="flex items-center gap-1">
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="bottom">Quick add</TooltipContent>
            </Tooltip>
          </TooltipProvider>
    ...
    <div
      class="mx-auto grid max-w-7xl flex-1 grid-cols-1 md:grid-cols-[260px_1fr]"
    >
      <!-- Desktop sidebar -->
      <aside
